...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> ColumnTransformer:
        try:
            ...
            categorical_columns = dataset_schema[CATEGORICAL_COLUMN_KEYS]
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        try:
            ...
            logging.info(
                f"Spliting input and Target feature from training and testing Dataframe")
            ...
            # input_feature_train_df.to_csv(r"C:\Us ers\dell\First_machine_Ml_project\input_featureTrain.csv",index=False)

            # input_feature_test_df.to_csv(r"C:\Users\dell\First_machine_Ml_project\input_featureTest.csv",index=False)
