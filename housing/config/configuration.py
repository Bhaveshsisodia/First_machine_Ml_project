from housing.entity.config_entity import DataIngestionConfig, DataValidationConfig, DataTransformationConfig,\
    ModelTrainingConfig, modelEvaluationConfig, ModelPusherConfig, TraningPipelineConfig
...
class Configuration:
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
        try:
            ...
            data_ingestion_config = DataIngestionConfig(
                dataset_download_dir=dataset_download_url,
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        try:
            ...
            schema_file_path = os.path.join(
                ROOT_DIR, data_validation_config[DATA_VALIDATION_SCHEMA_DIR_KEY], data_validation_config[DATA_VALIDATION_SCHEMA_FILE_NAME_KEY])
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            data_transormation_artifact_dir = os.path.join(artifact_dir,
            ...
            transformed_train_dir = os.path.join(data_transormation_artifact_dir,
                                                 data_transformation_config_info[DATA_TRANSFORMATION_DIR_NAME_KEY],
                                                 data_transformation_config_info[DATA_TRANSFORMATION_TRAIN_DIR_NAME_KEY])

            transformed_test_dir = os.path.join(data_transormation_artifact_dir,
                                                data_transformation_config_info[DATA_TRANSFORMATION_DIR_NAME_KEY],
                                                data_transformation_config_info[DATA_TRANSFORMATION_TEST_DIR_NAME_KEY])

            preprocessed_object_file_path = os.path.join(
                data_transormation_artifact_dir,
            ...
            logging.info(f"Data Transformation Config :{data_transformation_config_info}")
